...
const companyAddressModelFactory = require("./CompanyAddress");
const addressBotProfileModelFactory = require("./AddressBotProfile");
const addressBotTrainingExampleModelFactory = require("./AddressBotTrainingExample");
const addressBotTrainingChangeModelFactory = require("./AddressBotTrainingChange");
...
const userFileViewAccessModelFactory = require("./UserFileViewAccess");
const userFileHiddenFromModelFactory = require("./UserFileHiddenFrom");
const userFileAttachmentModelFactory = require("./UserFileAttachment");
...
const messageAttachmentModelFactory = require("./MessageAttachment");
const customerModelFactory = require("./Customer");
const customerPaymentMethodModelFactory = require("./CustomerPaymentMethod");
const customerChargeModelFactory = require("./CustomerCharge");
...
db.CompanyAddress = companyAddressModelFactory(sequelize, Sequelize.DataTypes);
db.AddressBotProfile = addressBotProfileModelFactory(sequelize, Sequelize.DataTypes);
db.AddressBotTrainingExample = addressBotTrainingExampleModelFactory(sequelize, Sequelize.DataTypes);
db.AddressBotTrainingChange = addressBotTrainingChangeModelFactory(sequelize, Sequelize.DataTypes);
...
db.UserFileViewAccess = userFileViewAccessModelFactory(sequelize, Sequelize.DataTypes);
db.UserFileHiddenFrom = userFileHiddenFromModelFactory(sequelize, Sequelize.DataTypes);
db.UserFileAttachment = userFileAttachmentModelFactory(sequelize, Sequelize.DataTypes);
...
db.MessageAttachment = messageAttachmentModelFactory(sequelize, Sequelize.DataTypes);
...
db.CustomerCharge = customerChargeModelFactory(sequelize, Sequelize.DataTypes);
